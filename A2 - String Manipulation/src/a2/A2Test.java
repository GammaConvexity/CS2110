...
class A2Test {
    ...
    @Test
    void testNCat() {
        assertEquals(A2.nCat("", ""), 0);
        assertEquals(A2.nCat("", "fg"), 0);
        assertEquals(A2.nCat("xxx", ""), -1);
        assertEquals(A2.nCat("x", "x"), 1);
        assertEquals(A2.nCat("xx", "x"), 2);
        assertEquals(A2.nCat("ccbbbb", "bb"), -1);
        assertEquals(A2.nCat("bbbbcc", "bb"), -1);
        assertEquals(A2.nCat("bbbbbb", "bb"), 3);
        assertEquals(A2.nCat("bbbbbb", "bbb"), 2);
        assertEquals(A2.nCat("bbbbbb", "bbbb"), -1);
        assertEquals(A2.nCat("bbbbbb", "bbbbb"), -1);
        assertEquals(A2.nCat("bbbbbb", "bbbbbb"), 1);
        assertEquals(A2.nCat("bbbbbb", "bbbbbbb"), -1);
        assertEquals(A2.nCat("xyzxyz", "xyz"), 2);
        assertEquals(A2.nCat("xyzxyz", "xyzxyz"), 1);
    }

    @Test
    void testShortest() {
        assertEquals(A2.shortest(""), 0);
        assertEquals(A2.shortest("xxxxxxxxx"), 1);
        assertEquals(A2.shortest("xyxyxyxy"), 2);
        assertEquals(A2.shortest("012012012012"), 3);
        assertEquals(A2.shortest("hellohellohello"), 5);
        assertEquals(A2.shortest("hellohelloworld"), 15);
        assertEquals(A2.shortest("hellohell"), 9);
    }
}
